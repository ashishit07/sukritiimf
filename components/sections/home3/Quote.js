...
export default function Quote() {
    ...
    return (
        ...
        <section className="get-quote get-quote-three">
            <div className="get-quote-three__shape-1"
                style={{ backgroundImage: 'url(assets/images/shapes/get-quote-three-shape-1.png)' }} ></div>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6">
                            <div className="get-quote__left clearfix">
                                <div className="get-quote-three__img-1">
                                    <img src="assets/images/resources/get-quote-three-img-1.png" alt=""/>
                                </div>
                                <h3 className="get-quote-three__title">Get an Insurance
                                    <br/> Quote to Get Started</h3>
